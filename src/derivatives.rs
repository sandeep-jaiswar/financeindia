...
pub fn bhav_copy_derivatives(client: &Client, date: &str, segment: &str) -> PyResult<bytes::Bytes> {
...
pub fn option_chain(client: &Client, symbol: &str, is_index: bool) -> PyResult<bytes::Bytes> {
...
pub fn fo_sec_ban(client: &Client) -> PyResult<bytes::Bytes> {
...
pub fn span_margins(client: &Client, date: &str) -> PyResult<bytes::Bytes> {
    let d = parse_date_robust(date)?;
...
pub fn fo_sec_ban_csv(client: &Client, date: &str) -> PyResult<bytes::Bytes> {
    let d = parse_date_robust(date)?;
...
pub fn participant_volume(client: &Client, date: &str) -> PyResult<bytes::Bytes> {
    let d = parse_date_robust(date)?;
...
pub fn oi_client_limits(client: &Client, date: &str) -> PyResult<bytes::Bytes> {
    let d = parse_date_robust(date)?;
